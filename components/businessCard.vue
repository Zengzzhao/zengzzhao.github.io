            ...
            <div class="business-card">
                <div class="business-flip">
                    <div class="business-front">
                        ...
                        <div class="business-strip-top"></div><img class="business-logo entered loaded" width="80"
                            height="80" src="https://s2.loli.net/2025/01/11/7mIexbu9TgEtBiK.jpg"
                            data-lazy-src="https://s2.loli.net/2025/01/11/7mIexbu9TgEtBiK.jpg" alt="cardcode"
                            data-ll-status="loaded">
                        <div class="business-Invitation">Invitation</div>
                        ...
                        </div><svg class="business-wave" viewBox="0 3.71 26.959 38.787" width="26.959" height="38.787"
                            fill="white">
                            <path
                        ...
                        <div class="business-card-number">
                            <div class="business-section">某曌</div>
                            <div class="business-section">1018605693</div>
                        </div>
                        <div class="business-end"><span class="business-end-text">created:</span><span
                                class="business-end-date">11/1/2025</span></div>
                        <div class="business-card-holder">Welcome to organization</div>
                    ...
                    <div class="business-back">
                        ...
                        <div class="business-ccv"><label>sitelink</label>
                            <div>
                                <a target="_blank"
                                    href="https://qm.qq.com/cgi-bin/qm/qr?k=VIkHbsQlD-iCBPT9GoSedTiSi7zD9Ph-&jump_from=webapi&authKey=K/DqfDhmVoX5Qt5J3TlvPQF5WwSESjVtbWedLOW6eTAvNUW5inzV35zDErIpR/mB">加入群聊【某曌的组织】</a>
                            </div>
                        </div>
                        <div class="business-terms">
                            <p>Use this card to join the organization and participate in a pleasant discussion
                                together
                                .</p>
                            <p>Welcome to 某曌's organization,wish you a nice day .</p>
                        </div>
                    </div>
                </div>
            </div>
...
.business-back .business-ccv div a {
    color: #9E9E9E;
...
.business-back .business-ccv div a:hover {
    color: #000000;
}
